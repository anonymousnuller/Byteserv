 ...
 */
namespace _PhpScoper7fb942e22fb5\Symfony\Polyfill\Intl\Idn;

use Exception;
use Normalizer;
use _PhpScoper7fb942e22fb5\Symfony\Polyfill\Intl\Idn\Resources\unidata\DisallowedRanges;
use _PhpScoper7fb942e22fb5\Symfony\Polyfill\Intl\Idn\Resources\unidata\Regex;
/**
...
final class Idn
{
    ...
    public static function idn_to_ascii($domainName, $options = self::IDNA_DEFAULT, $variant = self::INTL_IDNA_VARIANT_UTS46, &$idna_info = array())
    {
        ...
        $info = new \_PhpScoper7fb942e22fb5\Symfony\Polyfill\Intl\Idn\Info();
    ...
    private static function isValidContextJ(array $codePoints, $label)
    {
        ...
        foreach ($codePoints as $i => $codePoint) {
            ...
            if (0x200c === $codePoint && 1 === \preg_match(\_PhpScoper7fb942e22fb5\Symfony\Polyfill\Intl\Idn\Resources\unidata\Regex::ZWNJ, $label, $matches, \PREG_OFFSET_CAPTURE, $offset)) {
     ...
     * @return string
     */
    private static function mapCodePoints($input, array $options, \_PhpScoper7fb942e22fb5\Symfony\Polyfill\Intl\Idn\Info $info)
    {
        $str = '';
     ...
     */
    private static function process($domain, array $options, \_PhpScoper7fb942e22fb5\Symfony\Polyfill\Intl\Idn\Info $info)
    {
     ...
     * @param string $label
     */
    private static function validateBidiLabel($label, \_PhpScoper7fb942e22fb5\Symfony\Polyfill\Intl\Idn\Info $info)
    {
        if (1 === \preg_match(\_PhpScoper7fb942e22fb5\Symfony\Polyfill\Intl\Idn\Resources\unidata\Regex::RTL_LABEL, $label)) {
            $info->bidiDomain = \true;
            ...
            if (1 !== \preg_match(\_PhpScoper7fb942e22fb5\Symfony\Polyfill\Intl\Idn\Resources\unidata\Regex::BIDI_STEP_1_RTL, $label)) {
            ...
            if (1 === \preg_match(\_PhpScoper7fb942e22fb5\Symfony\Polyfill\Intl\Idn\Resources\unidata\Regex::BIDI_STEP_2, $label)) {
                $info->validBidiDomain = \false;
                return;
            }
            ...
            if (1 !== \preg_match(\_PhpScoper7fb942e22fb5\Symfony\Polyfill\Intl\Idn\Resources\unidata\Regex::BIDI_STEP_3, $label)) {
                $info->validBidiDomain = \false;
                return;
            }
            // Step 4. In an RTL label, if an EN is present, no AN may be present, and vice versa.
            if (1 === \preg_match(\_PhpScoper7fb942e22fb5\Symfony\Polyfill\Intl\Idn\Resources\unidata\Regex::BIDI_STEP_4_AN, $label) && 1 === \preg_match(\_PhpScoper7fb942e22fb5\Symfony\Polyfill\Intl\Idn\Resources\unidata\Regex::BIDI_STEP_4_EN, $label)) {
                $info->validBidiDomain = \false;
                return;
            }
            return;
        ...
        if (1 !== \preg_match(\_PhpScoper7fb942e22fb5\Symfony\Polyfill\Intl\Idn\Resources\unidata\Regex::BIDI_STEP_1_LTR, $label)) {
            $info->validBidiDomain = \false;
            return;
        }
        // Step 5. In an LTR label, only characters with the Bidi properties L, EN,
        // ES, CS, ET, ON, BN, or NSM are allowed.
        if (1 === \preg_match(\_PhpScoper7fb942e22fb5\Symfony\Polyfill\Intl\Idn\Resources\unidata\Regex::BIDI_STEP_5, $label)) {
            $info->validBidiDomain = \false;
            return;
        }
        ...
        if (1 !== \preg_match(\_PhpScoper7fb942e22fb5\Symfony\Polyfill\Intl\Idn\Resources\unidata\Regex::BIDI_STEP_6, $label)) {
            $info->validBidiDomain = \false;
            return;
        }
    }
     ...
     */
    private static function validateDomainAndLabelLength(array $labels, \_PhpScoper7fb942e22fb5\Symfony\Polyfill\Intl\Idn\Info $info)
    {
     ...
     */
    private static function validateLabel($label, \_PhpScoper7fb942e22fb5\Symfony\Polyfill\Intl\Idn\Info $info, array $options, $canBeEmpty)
    {
        if ('' === $label) {
        ...
        if (1 === \preg_match(\_PhpScoper7fb942e22fb5\Symfony\Polyfill\Intl\Idn\Resources\unidata\Regex::COMBINING_MARK, $label)) {
    ...
    private static function lookupCodePointStatus($codePoint, $useSTD3ASCIIRules)
    {
        ...
        if (isset(self::$disallowed[$codePoint]) || \_PhpScoper7fb942e22fb5\Symfony\Polyfill\Intl\Idn\Resources\unidata\DisallowedRanges::inRange($codePoint)) {
