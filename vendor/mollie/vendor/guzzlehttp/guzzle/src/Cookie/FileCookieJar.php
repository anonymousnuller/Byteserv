 ...
 */
class FileCookieJar extends \_PhpScoper7fb942e22fb5\GuzzleHttp\Cookie\CookieJar
{
    /** @var string filename */
    private $filename;
    ...
    public function save($filename)
    {
        ...
        $jsonStr = \_PhpScoper7fb942e22fb5\GuzzleHttp\json_encode($json);
    ...
    public function load($filename)
    {
        ...
        $data = \_PhpScoper7fb942e22fb5\GuzzleHttp\json_decode($json, \true);
        if (\is_array($data)) {
