...
class RetryMiddleware
{
     ...
     * @return mixed
     */
    private function onFulfilled(\_PhpScoper7fb942e22fb5\Psr\Http\Message\RequestInterface $req, array $options)
    {
     ...
     * @return callable
     */
    private function onRejected(\_PhpScoper7fb942e22fb5\Psr\Http\Message\RequestInterface $req, array $options)
    {
     ...
     * @return self
     */
    private function doRetry(\_PhpScoper7fb942e22fb5\Psr\Http\Message\RequestInterface $request, array $options, \_PhpScoper7fb942e22fb5\Psr\Http\Message\ResponseInterface $response = null)
    {
