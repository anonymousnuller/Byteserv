...
trait MessageTrait
{
    ...
    {
        if (!$this->stream) {
            $this->stream = \_PhpScoper7fb942e22fb5\GuzzleHttp\Psr7\Utils::streamFor('');
        }
        return $this->stream;
    }
    public function withBody(\_PhpScoper7fb942e22fb5\Psr\Http\Message\StreamInterface $body)
    {
        if ($body === $this->stream) {
            return $this;
        }
