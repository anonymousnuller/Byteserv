 ...
 */
class LimitStream implements \_PhpScoper7fb942e22fb5\Psr\Http\Message\StreamInterface
{
     ...
     */
    public function __construct(\_PhpScoper7fb942e22fb5\Psr\Http\Message\StreamInterface $stream, $limit = -1, $offset = 0)
    {
        $this->stream = $stream;
        $this->setLimit($limit);
