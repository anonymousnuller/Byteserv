 ...
 */
class AppendStream implements \_PhpScoper7fb942e22fb5\Psr\Http\Message\StreamInterface
{
     ...
     */
    public function addStream(\_PhpScoper7fb942e22fb5\Psr\Http\Message\StreamInterface $stream)
    {
