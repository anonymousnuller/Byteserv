<?php
$currPage = 'admin_vServer verwalten';
include 'app/controller/PageController.php';
include 'app/manager/team/vserver/manage.php';
?>
<form method="post">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <select class="form-control" name="osid" required="required">
                            <?php
                                    $SQL = $db->prepare("SELECT * FROM `vserver_os`");
                                    $SQL->execute(array());
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-outline-success" name="ReinstallLXC">Server neuinstallieren</button>
                </div>
            </div>
        </div>
    </div>
...
<form method="post">
    <div class="modal fade bd-example-modal-lg" id="changePriceModal" tabindex="-1" role="dialog" aria-labelledby="changePriceModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="changePriceModalLabel">Preis ändern</h5>
                </div>
                <div class="modal-body">

                    <label>Preis:</label>
                    <input class="form-control" name="newprice" value="<?= $serverInfos['price']; ?>">
                    <br>

                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-outline-danger" data-dismiss="modal">Schließen</button>
                    <button type="submit" class="btn btn-outline-success" name="ChangePrice">Preis ändern</button>
                </div>
            </div>
        </div>
    </div>
...
<form method="post">
    <div class="modal fade bd-example-modal-lg" id="changeExpireModal" tabindex="-1" role="dialog" aria-labelledby="changeExpireModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="changeExpireModalLabel">Preis ändern</h5>
                </div>
                <div class="modal-body">

                    <label>Datum:</label>
                    <input class="form-control" type="datetime-local" name="expire" value="<?= $expireat ?>">
                    <br>

                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-outline-danger" data-dismiss="modal">Schließen</button>
                    <button type="submit" class="btn btn-outline-success" name="ChangeExpire">Laufzeit ändern</button>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="col-md-8">
				...
				<div class="card card-body text-center shadow mb-5">
                    <form method="POST" action="">
							<button class="btn btn-outline-success btn-block" type="submit" name="StartLXC">Starten</button>
							<button class="btn btn-outline-danger btn-block" type="submit" name="StopLXC">Stoppen</button>
							<button class="btn btn-outline-warning btn-block" type="submit" name="RebootLXC">Neustarten</button>
                            ...
                            <p>TEAM</P>
                            <hr style="background-color: white;">
							<button class="btn btn-danger btn-block" type="submit" name="DeleteLXC">LÖSCHEN</button>
                            <button class="btn btn-warning btn-block" data-toggle="modal" data-target="#changeExpireModal" type="button">Laufzeit ändern</button>
                            <button class="btn btn-success btn-block" data-toggle="modal" data-target="#changePriceModal" type="button">Preis ändern</button>
                     </form>
					 </div>
					 </div>
            <div class="row">
