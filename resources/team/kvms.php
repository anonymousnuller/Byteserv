<?php
$currPage = 'back_Rootserver_admin';
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h3 class="card-title">Rootserver</h3>
                                </div>
                                <div class="card card-body text-center">
                                    <table id="dataTableDE" style="color:white;" class="table table-center table-padding mb-0">
										...
										<tbody>
<?php
            $SQL = $db->prepare("SELECT * FROM `kvmserver` WHERE `state` = 'active' OR `state` = 'suspended'");
            $SQL->execute(); 
            if ($SQL->rowCount() != 0) {
            ...
            if($row['state'] == 'active'){
                ...
                ?>
                                           ...
                                           <tr>
                                              ...
                                              <td><a href="<?= $helper->url(); ?>team/kvm/<?= $row['id']; ?>"><button class="btn btn-outline-primary btn-sm"><i class="fas fa-pencil-alt"></i></button></a> </td>
                                                </tr>
