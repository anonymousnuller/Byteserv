                ...
                <div class="row">
                    <div class="col-lg-4 col-12 mb-0 mb-md-4 pb-0 pb-md-2">
                        <a href="#" class="logo-footer">
                            <img src="<?= $helper->cdnUrl(); ?>images/logo-light.png" height="24" alt="">
                        </a>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-sm-6 mt-4 mt-sm-0 pt-2 pt-sm-0">
                        <ul class="list-unstyled text-sm-right mb-0">
                            <li class="list-inline-item"><a href="javascript:void(0)"><img src="<?= $helper->cdnUrl(); ?>images/payments/american-ex.png" class="avatar avatar-ex-sm" title="American Express" alt=""></a></li>
                            <li class="list-inline-item"><a href="javascript:void(0)"><img src="<?= $helper->cdnUrl(); ?>images/payments/discover.png" class="avatar avatar-ex-sm" title="Discover" alt=""></a></li>
                            <li class="list-inline-item"><a href="javascript:void(0)"><img src="<?= $helper->cdnUrl(); ?>images/payments/master-card.png" class="avatar avatar-ex-sm" title="Master Card" alt=""></a></li>
                            <li class="list-inline-item"><a href="javascript:void(0)"><img src="<?= $helper->cdnUrl(); ?>images/payments/paypal.png" class="avatar avatar-ex-sm" title="Paypal" alt=""></a></li>
                            <li class="list-inline-item"><a href="javascript:void(0)"><img src="<?= $helper->cdnUrl(); ?>images/payments/visa.png" class="avatar avatar-ex-sm" title="Visa" alt=""></a></li>
                        </ul>
                    </div><!--end col-->
                </div><!--end row-->
            </div><!--end container-->
        ...
        <!-- javascript -->
        <script src="<?= $helper->cdnUrl(); ?>js/jquery-3.5.1.min.js"></script>
        <script src="<?= $helper->cdnUrl(); ?>js/bootstrap.bundle.min.js"></script>
        <script src="<?= $helper->cdnUrl(); ?>js/jquery.easing.min.js"></script>
        <script src="<?= $helper->cdnUrl(); ?>js/scrollspy.min.js"></script>
        <!-- SLIDER -->
        <script src="<?= $helper->cdnUrl(); ?>js/owl.carousel.min.js "></script>
        <script src="<?= $helper->cdnUrl(); ?>js/owl.init.js "></script>
        <!-- Icons -->
        <script src="<?= $helper->cdnUrl(); ?>js/feather.min.js"></script>
        <script src="https://unicons.iconscout.com/release/v3.0.3/script/monochrome/bundle.js"></script>
        <!-- Main Js -->
        <script src="<?= $helper->cdnUrl(); ?>js/app.js"></script>
    </body>
</html>