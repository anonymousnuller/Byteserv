...
include 'app/manager/customer/vserver/order.php';
?>
    ...
    <div class="container">
        ...
        <div class="second-priceing-table text-center">
            <div class="row">
                ...
                <?php
                $SQL = $db->prepare("SELECT * FROM `vserver_packs`");
                $SQL->execute();
                if ($SQL->rowCount() != 0) {
                    ...
                    <div class="col-lg-4 col-md-6 col-12 mt-4 pt-2">
                        <div class="card explore-feature shadow bg-light rounded border-0">
                            <div class="card-body py-5">
                                <h4 class="title text-uppercase mb-4"><span class="badge rounded-pill bg-primary me-1 h6"><?= $row['name'] ?></span></h4>                        
