<?php
$currPage = 'front_vServer verwalten';
include 'app/controller/PageController.php';
include 'app/manager/customer/vserver/manage.php';
?>
<form method="post">
            ...
            <div class="col-md-8">
				...
				<div class="card card-body text-center shadow mb-5">
                    <form method="POST" action="">
							...
							<a class="btn btn-block btn-outline-info" href="<?= $helper->url(); ?>vserver/renew/<?= $id; ?>">Verlängern</a>
							<hr style="background-color: white;">
